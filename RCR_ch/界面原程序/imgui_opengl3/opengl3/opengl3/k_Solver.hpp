...
#include "k_KociMoveTables.hpp"
#include "k_RubiksCube.hpp"
#include "k_PruningTable.hpp"
...
public:
    ...
    int Solve(RubiksCube &scrambledCube, int second);
    // Solver return codes
    enum {
...
private:
    ...
    //   be disallowed.
    int Disallowed(int move, int* solutionMoves, int depth);
